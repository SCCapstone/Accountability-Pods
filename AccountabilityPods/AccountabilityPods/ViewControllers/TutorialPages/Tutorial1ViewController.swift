...
//
//  Description: Manages first tutorial page
...
class Tutorial1ViewController: UIViewController {
    ...
    /// The button to close out of the tutorial
    ...
    @IBAction func nextTapped(_ sender: Any) {
        let nextViewController = storyboard?.instantiateViewController(identifier: "tutorial2")
